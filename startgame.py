...
class StartGame:
    ...
    def one_player(self):
        return Game(Player("X", self._input, self._output), AIPlayer("O"), self._output, Board(self._output))
        
    def two_player(self):                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
        return Game(Player("X", self._input, self._output), Player("O", self._input, self._output), self._output, Board(self._output))
